    ...
    <div style={{ minHeight: "100vh", background: "#0a1628", color: "#e2e8f0" }}>
      ...
      <main style={{ maxWidth: 780, margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        ...
        <LegalSection title="2. Description of Service">
          <p>
            MineralFlow AI is a software platform designed to assist mineral rights professionals —
            including landmen, acquisition teams, and mineral buyers — with acquisition due diligence on
            Texas oil and gas wells and leases. Given a well API number, lease number, operator name, or
            legal description, the Service retrieves public records from the Texas Railroad Commission
            (TRRC) and returns a structured due diligence report, including engineering, economic, and
            risk analysis derived from that public data, generated by MineralFlow's own deterministic
            software.
          </p>
        </LegalSection>
        ...
        <LegalSection title="7. Automated Outputs — Important Disclaimer">
          <p>
        ...
        <LegalSection title="11. Third-Party Services">
          <p>
            ...
            and Supabase (data storage), and retrieves public records from the Texas Railroad
            Commission (TRRC). Your use of those services is also subject to their respective terms
            and privacy policies. We are not responsible for the practices of third-party providers.
            No third-party AI provider is used in the Service's retrieval or analysis path — see our
