/**
 * Texas county FIPS code (the 3-digit middle segment of a Texas API
 * number) -> county name. All 254 counties; FIPS codes are odd, 001-507.
 * Used to validate the county component of an API number and to name the
 * county for county-clerk record searches without a TRRC round trip.
 */
export const COUNTY_CODE_TO_NAME: Record<string, string> = {
