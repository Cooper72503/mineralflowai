-- Reapply the idempotent atomic publisher after the independently numbered 029 acquisition migration.
-- This covers deployments whose migration ledger already used version 029 for acquisition columns.
